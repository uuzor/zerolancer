...
export const ZEROLANCE_TASK_VERIFIER_ABI = [
  {
    "type": "constructor",
    "inputs": [],
  ...
  },
  {
    ...
    "inputs": [
      ...
      { "name": "teeVerifier", "type": "address", "internalType": "address" },
      { "name": "taskEscrow", "type": "address", "internalType": "address" },
      { "name": "reputationNft", "type": "address", "internalType": "address" },
