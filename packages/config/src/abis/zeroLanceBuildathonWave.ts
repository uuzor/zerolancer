...
export const ZEROLANCE_BUILDATHON_WAVE_ABI = [
  {
    "type": "constructor",
    "inputs": [],
  ...
  },
  {
    ...
    "outputs": [
      { "name": "teamId", "type": "uint256", "internalType": "uint256" }
    ],
    "stateMutability": "nonpayable"
  },
  {
    ...
    "outputs": [
      {
        "name": "",
        "type": "tuple",
        "internalType": "struct IZeroLanceBuildathonWave.Submission",
        "components": [
          { "name": "programId", "type": "uint256", "internalType": "uint256" },
    ...
    "outputs": [
      {
        "name": "",
        "type": "tuple",
        "internalType": "struct IZeroLanceBuildathonWave.Team",
        "components": [
          { "name": "programId", "type": "uint256", "internalType": "uint256" },
          { "name": "wallet", "type": "address", "internalType": "address" },
          { "name": "repoHash", "type": "bytes32", "internalType": "bytes32" },
  ...
  },
  {
    ...
    "inputs": [
      ...
      { "name": "teamId", "type": "uint256", "indexed": true, "internalType": "uint256" },
